# 310 epochs 241 学习率lr=0.02 split_coco_data
auto_scale_lr = dict(base_batch_size=4, enable=False)
backend_args = None
data_root = '../data/split_coco_data/'
...
test_evaluator = dict(
    ann_file='../data/split_coco_data/annotations/instances_val.json',
    backend_args=None,
    format_only=False,
    metric='bbox',
    type='CocoMetric')
...
work_dir = './work_dirs\\cascade-rpn_faster-rcnn_r50-caffe_fpn_1x_coco'

...
optim_wrapper = dict(
    ...
    optimizer=dict(lr=0.004, momentum=0.9, type='SGD', weight_decay=4e-05),
...
train_cfg = dict(max_epochs=epochs, type='EpochBasedTrainLoop', val_interval=5)
...
work_dir = './work_dirs\\fcos_r50_fpn_gn-head-center-normbbox-centeronreg-giou_8xb8-amp-lsj-200e_coco'

...
test_dataloader = dict(
    batch_size=1,
    dataset=dict(
        ann_file='../../data/coco_data/val/labels',
        backend_args=None,
...
train_dataloader = dict(
    ...
    batch_size=8,
    dataset=dict(
        ann_file='../../data/coco_data/train/labels',
        backend_args=None,
...
checkpoint ='F:\leiyinglan\project\X-ray\demo\x-ray-code\detection\MMDetection-main\configs\yolo\yolov3_d53_fp16_mstrain-608_273e_coco_20210517_213542-4bc34944.pth'
work_dir = './work_dirs\\yolov3_d53_8xb8-amp-ms-608-273e_coco'

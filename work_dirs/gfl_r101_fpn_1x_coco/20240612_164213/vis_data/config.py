...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=
        'E:/LYL/X-ray/x-ray-code/detection/MMDetection-main/data/coco/',
        pipeline=[
...
test_evaluator = dict(
    ann_file=
    'E:/LYL/X-ray/x-ray-code/detection/MMDetection-main/data/coco/annotations/instances_test.json',
    backend_args=None,
    format_only=False,
    metric='bbox',
    type='CocoMetric')

...
epochs = 100
launcher = 'none'
load_from = 'tools/work_dirs/gfl_r101_fpn_1x_coco/20240322_221432_43.8/epoch_35.pth'
log_level = 'INFO'
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=
        'E:/雷英兰/01手骨骨折X射线图像分类与定位/demo/detection/MMDetection-main/data/coco/',
        pipeline=[
...
test_evaluator = dict(
    ann_file=
    'E:/雷英兰/01手骨骨折X射线图像分类与定位/demo/detection/MMDetection-main/data/coco/annotations/instances_test.json',
    backend_args=None,
    format_only=False,
    metric='bbox',
    type='CocoMetric')

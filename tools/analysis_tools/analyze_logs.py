...
# python detection/MMDetection-main/tools/analysis_tools/analyze_logs.py
# plot_curve detection/MMDetection-main/tools/work_dirs/faster-rcnn_r50_fpn_ms-3x_coco/20240203_145428_3X/vis_data/20240203_145428.json
# --keys loss loss_rpn_cls loss_rpn_bbox loss_cls loss_bbox
# --out faster-rcnn_r50_fpn_loss.jpg
# --show_dir result/train_result
import argparse
import json
